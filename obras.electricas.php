...
<body>
  ...
  <span id="status-indicator" class="status-indicator status-<?php echo $status; ?>"></span>
   ...
   <p class="titulo-sliders">Diseño, instalación y mantenimiento de sistemas eléctricos para proyectos residenciales,
            ...
            <div class="inner">
               <div class="slide slide_1">
                  <div class="slide-content">
                     <h3>Mantenimiento preventivo y predictivo</h3>
                     <p>Asegurar el buen funcionamiento de las instalaciones eléctricas de cualquier tipo</p>
                  </div>
               </div>
