...
<head>
  ...
  <!-- aca podremos agregar un favicon de la web, esto es el icono pequeño que aparece en el explorador
  ...
  <div class="container">
    ...
    <form class="row">
      ...
      <div class="col s12">
        ...
        <textarea id="message" name="message" class="materialize-textarea expanded-textarea"></textarea>
      </div>
